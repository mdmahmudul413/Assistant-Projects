                        ...
                        <div class="post-details">
                            <div class="main-content-head">
                                ...
                                <div class="meta-information">
                                    ...
                                    <ul class="meta-info">
                                        <li>
                                            <a href="javascript:void(0)"> <i class="lni lni-user"></i>{{ $blog->user->name }}</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)"><i class="lni lni-calendar"></i>{{ $blog->created_at }}</a>
                                        </li>
                                    </ul>
                                ...
                                <div class="detail-inner">
                                    ...
                                    <div class="post-bottom-area">
                                        ...
                                        <div class="post-social-media">
                                            <h5 class="share-title text-danger">Share post :</h5>
                                            <ul>
                                                <li>
