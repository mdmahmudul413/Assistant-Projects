                ...
                <div class="card-body">
                    ...
                    <form action="{{route('blog.update', ['id' => $blog->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ $blog->title }}" type="text" class="form-control" id="horizontal-firstname-input" name="title"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Blog Description</label>
                            <div class="col-sm-9">
                                <textarea class="form-control summernote" name="description" rows="5">{{ $blog->description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img class="mt-3" src="{{ asset('/') }}{{ $blog->image }}" alt="Blog Image" height="200" width="320"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-9">
                                <div>
                                    <button type="submit" class="btn btn-primary w-md">Edit Blog</button>
                                </div>
                            </div>
                        </div>
                    </form>
